...
void AFPSTemplateCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &AFPSTemplateCharacter::Look);
...
void AFPSTemplateCharacter::DoMove(float Right, float Forward)
{
...
void AFPSTemplateCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void AFPSTemplateCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void AFPSTemplateCharacter::DoJumpEnd()
{
